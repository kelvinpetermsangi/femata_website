    ...
    public function run(): void
    {
        ...
        $galleryAssets = [
            [
                ...
                'event_name' => 'National leadership forum',
            ...
            [
                ...
                'event_name' => 'Lake Zone field coordination visit',
            ...
            [
                ...
                'event_name' => 'National secretariat media desk',
            ...
            [
                ...
                'event_name' => 'Safety and compliance clinic',
                'event_date' => Carbon::now()->subWeeks(5)->toDateString(),
                'display_order' => 5,
                'is_featured' => false,
            ],
            [
            ...
            [
                ...
                'event_name' => 'Women miners enterprise roundtable',
        ...
        foreach ($galleryAssets as $asset) {
            ...
            GalleryItem::query()->updateOrCreate(
                ...
                [
                    'title' => $asset['title'],
                    'caption' => $asset['caption'],
                    'event_name' => $asset['event_name'] ?? null,
                    'event_date' => $asset['event_date'] ?? null,
            ...
            [
                ...
                'gallery' => [
                    [
                        ...
                        'event_title' => 'Lake Zone field briefing',
                        'event_date' => Carbon::now()->subWeeks(6)->toDateString(),
            ...
            [
                ...
                'gallery' => [
                    [
                        ...
                        'event_title' => 'Women miners enterprise clinic',
                        'event_date' => Carbon::now()->subWeeks(4)->toDateString(),
            ...
            [
                ...
                'leaders' => [
                    ...
                    [
                        ...
                        'bio' => 'Coordinates records, stakeholder follow-up, and day-to-day secretariat delivery for the association.',
                        'photo_path' => 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=500&q=80',
                        'email' => 'rose@dama.or.tz',
                        'phone' => '+255 759 100 415',
                    ],
                ],
                'gallery' => [
                    [
                        'image_path' => 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=1200&q=80',
                        'event_title' => 'Central Zone coordination session',
                        'event_date' => Carbon::now()->subWeeks(7)->toDateString(),
            ...
            [
                ...
                'leaders' => [
                    ...
                    [
                        'name' => 'John T. Mhando',
                        'group' => 'secretariat',
                        'title' => 'Forum Secretary',
                        'bio' => 'Supports documentation, supplier records, and coordination with regional partners and buyers.',
                        'photo_path' => 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=500&q=80',
                        'email' => 'john@mlcpf.or.tz',
                        'phone' => '+255 764 310 282',
                    ],
                ],
                'gallery' => [
                    [
                        'image_path' => 'https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1200&q=80',
                        'event_title' => 'Local supplier readiness forum',
                        'event_date' => Carbon::now()->subWeeks(5)->toDateString(),
        ...
        $programs = [
            [
                'slug' => 'tanzania-mining-exhibition-conference',
                'name' => 'Tanzania Mining Exhibition and Conference',
                'tagline' => 'FEMATA’s annual corporate showcase for mining dialogue, exhibitions, and partnerships.',
                'summary' => 'A flagship FEMATA platform bringing together miners, associations, exhibitors, service providers, financiers, policymakers, and partners through an annual host-region edition with its own program identity and delivery cycle.',
                'hero_image' => 'https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&w=1600&q=80',
                'home_title' => 'A national exhibition and conference platform with regional delivery every year',
                'home_intro' => 'This homepage is built to present the exhibition and conference as a standalone corporate-style program, not as a news article. It explains the scale, visibility, and commercial value of the initiative before visitors move into year-specific participation and registration pages.',
                'home_body' => 'The Tanzania Mining Exhibition and Conference is designed as a flagship national-facing platform under FEMATA, rotating across regions to strengthen visibility, participation, and partnership around Tanzania’s mining economy. It provides a structured meeting point for miners, Regional Miners’ Associations, suppliers, banks, equipment firms, logistics providers, laboratories, training institutions, and public-sector stakeholders. By giving each edition a clear host region, theme, and participation cycle, the program creates a more visible route for stakeholder engagement while also expanding regional opportunity, public awareness, and business discovery.',
                'about_title' => 'A FEMATA platform for national sector visibility and partnership-making',
                'about_body' => 'The program exists to create a high-quality national platform where Tanzania’s mining ecosystem can convene, exhibit, build partnerships, and communicate practical investment and productivity opportunities. FEMATA uses the program to connect miners and associations with financiers, suppliers, government agencies, corporate buyers, and development institutions in a setting that is more visible, structured, and commercially useful than ordinary event publicity. Each annual edition combines exhibitions, conference sessions, floor planning, partner showcases, technical learning, and a host-region spotlight.',
                'team_intro' => 'The program is coordinated through a delivery team that combines national oversight, host-region coordination, partnerships, exhibitor relations, and stakeholder communications.',
                'years_intro' => 'Each edition is presented as part of an annual cycle, making it easy to review how the program evolves by host region, theme, and delivery priorities over time.',
                'current_year_intro' => 'The current-year page is the operational surface for the live edition, bringing together theme, venue direction, sponsor pathways, vendor onboarding, participant registration, and floor-planning material in one place.',
                'highlights' => [
                    ['title' => 'Regional rotation', 'text' => 'The program travels across Tanzania so different mining corridors can host and benefit from national visibility.'],
                    ['title' => 'Exhibition-led visibility', 'text' => 'Suppliers, partners, member associations, and institutions can exhibit in a stronger public-facing environment.'],
                    ['title' => 'Commercial and policy interface', 'text' => 'The conference layer creates space for finance, technology, governance, and partnership conversations around practical sector growth.'],
                ],
                'metrics' => [
                    ['label' => 'Editions seeded', 'value' => '3', 'note' => 'Three public editions are preloaded to show how annual cycles can be presented.'],
                    ['label' => 'Program teams', 'value' => '5', 'note' => 'The seed profile includes multiple delivery roles rather than one generic owner.'],
                    ['label' => 'Live pathways', 'value' => '5', 'note' => 'Vendor, participant, sponsor, brochure, and floor-plan routes are surfaced on the current-year page.'],
                ],
                'team' => [
                    ['name' => 'Neema J. Mwangosi', 'title' => 'Program Director', 'bio' => 'Leads national delivery planning, host-region coordination, and executive alignment for the annual exhibition and conference cycle.', 'photo_path' => 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=700&q=80', 'email' => 'programs@femata.or.tz', 'phone' => '+255 754 110 221'],
                    ['name' => 'Patrick A. Msangi', 'title' => 'Partnerships Lead', 'bio' => 'Coordinates sponsor relations, institutional partnerships, and private-sector campaign alignment for each edition.', 'photo_path' => 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=700&q=80', 'email' => 'partners@femata.or.tz', 'phone' => '+255 754 118 302'],
                    ['name' => 'Asha K. Komba', 'title' => 'Exhibitor Relations Manager', 'bio' => 'Oversees exhibitor onboarding, floor-plan communication, and experience support for vendors and suppliers.', 'photo_path' => 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=700&q=80', 'email' => 'exhibitors@femata.or.tz', 'phone' => '+255 759 880 112'],
                    ['name' => 'Moses T. Matata', 'title' => 'Host Region Coordinator', 'bio' => 'Connects the current host region to national delivery timelines, local logistics, and stakeholder mobilization.', 'photo_path' => 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=700&q=80', 'email' => 'hostregion@femata.or.tz', 'phone' => '+255 784 600 745'],
                    ['name' => 'Rehema S. Kalinga', 'title' => 'Communications and Registration Lead', 'bio' => 'Manages public updates, registration journeys, and attendee-facing information across the live edition.', 'photo_path' => 'https://images.unsplash.com/photo-1544723795-3fb6469f5b39?auto=format&fit=crop&w=700&q=80', 'email' => 'registration@femata.or.tz', 'phone' => '+255 764 118 940'],
                ],
                'years' => [
                    [
                        'year' => 2026,
                        'edition_label' => 'TMEC 2026 | Mwanza Edition',
                        'region' => 'Mwanza',
                        'venue' => 'Mwanza Conference and Exhibition Grounds',
                        'date_summary' => '18-21 November 2026',
                        'theme' => 'Connecting ASM productivity, local content, and finance-ready mining growth',
                        'overview' => 'The 2026 edition is positioned as a high-visibility Lake Zone showcase, connecting exhibitors, mining associations, service providers, banks, and public institutions around practical growth opportunities in Tanzania’s mining economy.',
                        'highlights' => [
                            'National exhibition floor for suppliers, service providers, and partner institutions',
                            'Conference sessions on formalization, productivity, finance, ESG, and technology',
                            'Host-region spotlight for Mwanza and the wider Lake Zone mining corridor',
                        ],
                        'vendor_registration_url' => 'https://femata.or.tz/contact?program=tmec-2026&role=vendor',
                        'participant_registration_url' => 'https://femata.or.tz/contact?program=tmec-2026&role=participant',
                        'sponsor_registration_url' => 'https://femata.or.tz/contact?program=tmec-2026&role=sponsor',
                        'floor_plan_url' => 'https://femata.or.tz/contact?program=tmec-2026&asset=floor-plan',
                        'brochure_url' => 'https://femata.or.tz/contact?program=tmec-2026&asset=brochure',
                        'is_current' => true,
                    ],
                    [
                        'year' => 2025,
                        'edition_label' => 'TMEC 2025 | Geita Edition',
                        'region' => 'Geita',
                        'venue' => 'Geita Regional Exhibition Pavilion',
                        'date_summary' => '20-23 November 2025',
                        'theme' => 'Regional productivity, safer operations, and visible mining partnerships',
                        'overview' => 'The Geita edition focused on stronger association visibility, equipment access, and a more structured regional interface between miners, suppliers, and institutions.',
                        'highlights' => [
                            'Regional miner associations and suppliers shared one public-facing platform',
                            'Safety and recovery technology received dedicated attention in floor activations',
                            'Host-region business opportunities were profiled for local and national partners',
                        ],
                        'vendor_registration_url' => 'https://femata.or.tz/contact?program=tmec-2025&role=vendor',
                        'participant_registration_url' => 'https://femata.or.tz/contact?program=tmec-2025&role=participant',
                        'sponsor_registration_url' => 'https://femata.or.tz/contact?program=tmec-2025&role=sponsor',
                        'floor_plan_url' => 'https://femata.or.tz/contact?program=tmec-2025&asset=floor-plan',
                        'brochure_url' => 'https://femata.or.tz/contact?program=tmec-2025&asset=brochure',
                        'is_current' => false,
                    ],
                    [
                        'year' => 2024,
                        'edition_label' => 'TMEC 2024 | Arusha Edition',
                        'region' => 'Arusha',
                        'venue' => 'Arusha International Event Arena',
                        'date_summary' => '14-16 November 2024',
                        'theme' => 'Visibility, innovation, and regional showcase for Tanzania’s mining ecosystem',
                        'overview' => 'The Arusha edition established the stronger corporate format for how the conference and exhibition could be presented to partners, exhibitors, and media audiences.',
                        'highlights' => [
                            'Corporate-style program presentation with exhibitions and conference tracks',
                            'Stronger partner engagement and clearer exhibitor journeys',
                            'Expanded public visibility for member associations and regional mining narratives',
                        ],
                        'vendor_registration_url' => 'https://femata.or.tz/contact?program=tmec-2024&role=vendor',
                        'participant_registration_url' => 'https://femata.or.tz/contact?program=tmec-2024&role=participant',
                        'sponsor_registration_url' => 'https://femata.or.tz/contact?program=tmec-2024&role=sponsor',
                        'floor_plan_url' => 'https://femata.or.tz/contact?program=tmec-2024&asset=floor-plan',
                        'brochure_url' => 'https://femata.or.tz/contact?program=tmec-2024&asset=brochure',
                        'is_current' => false,
                    ],
                ],
            ],
            [
                'slug' => 'asm-formalization-productivity-clinics',
                'name' => 'ASM Formalization and Productivity Clinics',
                'tagline' => 'A structured field-support program connecting miners to documentation, technology, and productivity improvement.',
                'summary' => 'A FEMATA program focused on practical field clinics around licensing readiness, records, productivity, safety, market systems, and operational modernization for artisanal and small-scale miners.',
                'hero_image' => 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=1600&q=80',
                'home_title' => 'Field clinics that turn formalization and productivity into practical support',
                'home_intro' => 'This program page is designed to present field support as a recognizable FEMATA initiative with its own teams, annual cycle, and delivery focus rather than as scattered outreach activity.',
                'home_body' => 'The clinics program helps FEMATA translate national priorities into practical site-level support. It is built around focused engagements on documentation, licensing, records, recovery improvement, safety culture, finance readiness, and operational discipline. By packaging these interventions as a visible program, FEMATA can show continuity across regions, track delivery themes over time, and make it easier for partners to support or align with technical field work.',
                'about_title' => 'A practical modernization pathway for artisanal and small-scale mining',
                'about_body' => 'The clinics are structured as direct-support engagements for miners and associations that need guidance on formalization, productivity, and practical operational improvement. The program creates a clearer bridge between federation advocacy and field implementation by packaging support around repeatable modules, region-specific priorities, and measurable delivery themes.',
                'team_intro' => 'The clinics are delivered through a mixed team spanning field coordination, technical guidance, documentation support, and stakeholder follow-up.',
                'years_intro' => 'Each annual cycle shows how the program shifts across regions and delivery themes while retaining a consistent focus on formalization, productivity, and safer practice.',
                'current_year_intro' => 'The current year section highlights the active clinic cycle, upcoming region, participation pathway, and tools being emphasized in the live program window.',
                'highlights' => [
                    ['title' => 'Field-based delivery', 'text' => 'The program meets miners and association teams closer to operating realities rather than only through desk-based communication.'],
                    ['title' => 'Structured modules', 'text' => 'Formalization, productivity, safety, and finance readiness are delivered through repeatable support modules.'],
                    ['title' => 'Regional adaptation', 'text' => 'Each annual cycle adjusts its emphasis around the needs of the regions being served.'],
                ],
                'metrics' => [
                    ['label' => 'Annual cycle', 'value' => '4', 'note' => 'Four core field support windows are planned across the year.'],
                    ['label' => 'Priority themes', 'value' => '6', 'note' => 'The seeded profile demonstrates six areas of practical support focus.'],
                    ['label' => 'Regional readiness', 'value' => '3', 'note' => 'The sample dataset shows multi-region delivery by year.'],
                ],
                'team' => [
                    ['name' => 'Godfrey E. Mnyange', 'title' => 'Technical Clinics Lead', 'bio' => 'Coordinates the structure and technical focus of clinic sessions across licensing, recovery, and safer production methods.', 'photo_path' => 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=700&q=80', 'email' => 'clinics@femata.or.tz', 'phone' => '+255 754 118 212'],
                    ['name' => 'Anna P. Msuya', 'title' => 'Formalization Support Coordinator', 'bio' => 'Supports licensing guidance, documentation follow-up, and records readiness for members participating in the clinics.', 'photo_path' => 'https://images.unsplash.com/photo-1545239351-1141bd82e8a6?auto=format&fit=crop&w=700&q=80', 'email' => 'formalization@femata.or.tz', 'phone' => '+255 762 401 331'],
                    ['name' => 'Lucas M. Chuwa', 'title' => 'Field Logistics and Outreach', 'bio' => 'Manages region-level coordination, mobilization, and clinic scheduling with host associations and local partners.', 'photo_path' => 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=700&q=80', 'email' => 'fieldops@femata.or.tz', 'phone' => '+255 764 618 909'],
                ],
                'years' => [
                    [
                        'year' => 2026,
                        'edition_label' => 'ASM Clinics 2026 | Lake and Central Zones',
                        'region' => 'Geita, Mwanza, Dodoma',
                        'venue' => 'Regional association field sites and training rooms',
                        'date_summary' => 'June-October 2026',
                        'theme' => 'From licensing readiness to stronger recovery and market discipline',
                        'overview' => 'The live cycle is focused on helping miners and associations improve operational visibility, records, production discipline, and finance readiness through targeted practical clinics.',
                        'highlights' => [
                            'Licensing and records support for site and association leaders',
                            'Productivity clinics on safer methods, recovery, and workflow discipline',
                            'Finance-readiness conversations for operators moving toward bankable structures',
                        ],
                        'vendor_registration_url' => 'https://femata.or.tz/contact?program=asm-clinics-2026&role=technical-partner',
                        'participant_registration_url' => 'https://femata.or.tz/contact?program=asm-clinics-2026&role=participant',
                        'sponsor_registration_url' => 'https://femata.or.tz/contact?program=asm-clinics-2026&role=sponsor',
                        'floor_plan_url' => 'https://femata.or.tz/contact?program=asm-clinics-2026&asset=session-plan',
                        'brochure_url' => 'https://femata.or.tz/contact?program=asm-clinics-2026&asset=brief',
                        'is_current' => true,
                    ],
                    [
                        'year' => 2025,
                        'edition_label' => 'ASM Clinics 2025 | Southern Corridor',
                        'region' => 'Mbeya, Songwe, Rukwa',
                        'venue' => 'Regional association coordination centres',
                        'date_summary' => 'May-August 2025',
                        'theme' => 'Safer operations, cleaner records, and stronger operational support',
                        'overview' => 'The 2025 cycle focused on regional coordination and practical compliance support tied to field realities.',
                        'highlights' => [
                            'Association-admin sessions on member documentation and reporting',
                            'Field demonstrations linked to safety and productivity improvement',
                            'Structured stakeholder follow-up across the host regions',
                        ],
                        'vendor_registration_url' => 'https://femata.or.tz/contact?program=asm-clinics-2025&role=technical-partner',
                        'participant_registration_url' => 'https://femata.or.tz/contact?program=asm-clinics-2025&role=participant',
                        'sponsor_registration_url' => 'https://femata.or.tz/contact?program=asm-clinics-2025&role=sponsor',
                        'floor_plan_url' => 'https://femata.or.tz/contact?program=asm-clinics-2025&asset=session-plan',
                        'brochure_url' => 'https://femata.or.tz/contact?program=asm-clinics-2025&asset=brief',
                        'is_current' => false,
                    ],
                ],
            ],
            [
                'slug' => 'women-youth-mining-enterprise-accelerator',
                'name' => 'Women and Youth Mining Enterprise Accelerator',
                'tagline' => 'A FEMATA inclusion platform focused on enterprise confidence, visibility, and growth support.',
                'summary' => 'A specialized program designed to strengthen the participation, visibility, and enterprise readiness of women-led and youth-led actors across Tanzania’s mining ecosystem.',
                'hero_image' => 'https://images.unsplash.com/photo-1520607162513-77705c0f0d4a?auto=format&fit=crop&w=1600&q=80',
                'home_title' => 'An accelerator for women and youth participation in the mining economy',
                'home_intro' => 'This program creates a dedicated corporate-style space for FEMATA to show how inclusion, enterprise support, and practical opportunity pathways are being advanced through a focused initiative.',
                'home_body' => 'The accelerator program exists to strengthen the visibility and quality of participation for women and youth across the mining economy. It provides a more structured platform for enterprise support, market readiness, network-building, leadership visibility, and practical growth conversations. Rather than treating inclusion as a side note inside general sector content, the program gives it a clear identity, named delivery teams, and annual programming that can be understood by participants, partners, financiers, and institutional stakeholders.',
                'about_title' => 'A focused platform for inclusion, enterprise confidence, and public visibility',
                'about_body' => 'The program supports women-led and youth-led participants across processing, services, trading, logistics, local content, and mining-linked enterprise activity. It is designed to create clearer pathways into training, market visibility, leadership confidence, and partnership engagement while also making inclusion work more visible as a structured FEMATA program rather than an occasional event theme.',
                'team_intro' => 'The accelerator combines mentorship, enterprise support, communications, and partnership coordination into one visible delivery structure.',
                'years_intro' => 'The annual view shows how the accelerator evolves around different inclusion priorities, enterprise themes, and host locations over time.',
                'current_year_intro' => 'The current-year program page highlights the live cycle, active theme, partner engagement pathway, and participant-facing links for the latest accelerator edition.',
                'highlights' => [
                    ['title' => 'Inclusion with structure', 'text' => 'The program turns participation and empowerment work into a visible and repeatable FEMATA initiative.'],
                    ['title' => 'Enterprise readiness', 'text' => 'Women-led and youth-led businesses can be profiled around confidence, organization, and market visibility.'],
                    ['title' => 'Partnership-friendly design', 'text' => 'Sponsors, institutions, and mentors can see exactly how the program is framed and where support fits.'],
                ],
                'metrics' => [
                    ['label' => 'Focus segments', 'value' => '2', 'note' => 'Women and youth are surfaced as visible segments without losing the shared ecosystem view.'],
                    ['label' => 'Delivery streams', 'value' => '4', 'note' => 'Mentorship, enterprise readiness, visibility, and partnerships are all represented in the profile.'],
                    ['label' => 'Current cycle', 'value' => '2026', 'note' => 'The live edition is already structured with participant and sponsor pathways.'],
                ],
                'team' => [
                    ['name' => 'Janeth M. Mhando', 'title' => 'Accelerator Lead', 'bio' => 'Leads strategic delivery and partner engagement for the women and youth mining enterprise accelerator.', 'photo_path' => 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=700&q=80', 'email' => 'accelerator@femata.or.tz', 'phone' => '+255 754 661 445'],
                    ['name' => 'Kelvin P. Rweyemamu', 'title' => 'Youth Enterprise Coordinator', 'bio' => 'Supports youth-focused enterprise sessions, growth planning, and practical participation pathways.', 'photo_path' => 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=700&q=80', 'email' => 'youth@femata.or.tz', 'phone' => '+255 756 322 118'],
                    ['name' => 'Mariam T. Lwega', 'title' => 'Women in Mining Partnerships', 'bio' => 'Coordinates women-led enterprise visibility, mentor engagements, and partner follow-up for the program.', 'photo_path' => 'https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?auto=format&fit=crop&w=700&q=80', 'email' => 'women@femata.or.tz', 'phone' => '+255 784 332 015'],
                ],
                'years' => [
                    [
                        'year' => 2026,
                        'edition_label' => 'Accelerator 2026 | Mbeya Inclusion and Enterprise Cycle',
                        'region' => 'Mbeya',
                        'venue' => 'Mbeya Regional Enterprise Hub',
                        'date_summary' => 'August-November 2026',
                        'theme' => 'Building enterprise confidence, inclusive participation, and mining-linked growth pathways',
                        'overview' => 'The live cycle focuses on giving women-led and youth-led mining enterprises a stronger public and partnership-facing platform while supporting confidence, documentation, and visibility.',
                        'highlights' => [
                            'Mentor-led support clinics for enterprise visibility and growth planning',
                            'Program windows for participant onboarding, sponsor engagement, and partner activation',
                            'A stronger public-facing platform for inclusive mining enterprise narratives',
                        ],
                        'vendor_registration_url' => 'https://femata.or.tz/contact?program=accelerator-2026&role=service-partner',
                        'participant_registration_url' => 'https://femata.or.tz/contact?program=accelerator-2026&role=participant',
                        'sponsor_registration_url' => 'https://femata.or.tz/contact?program=accelerator-2026&role=sponsor',
                        'floor_plan_url' => 'https://femata.or.tz/contact?program=accelerator-2026&asset=programme-layout',
                        'brochure_url' => 'https://femata.or.tz/contact?program=accelerator-2026&asset=brochure',
                        'is_current' => true,
                    ],
                    [
                        'year' => 2025,
                        'edition_label' => 'Accelerator 2025 | Arusha Visibility Cycle',
                        'region' => 'Arusha',
                        'venue' => 'Arusha Women in Mining Centre',
                        'date_summary' => 'July-October 2025',
                        'theme' => 'Visibility, confidence, and enterprise-readiness for inclusive mining participation',
                        'overview' => 'The 2025 cycle emphasized visibility and public-facing confidence for women-led and youth-led participants working across mining-linked enterprise areas.',
                        'highlights' => [
                            'Enterprise storytelling and visibility support',
                            'Mentorship sessions on readiness, records, and partner conversations',
                            'A clearer inclusion-focused public platform inside FEMATA programming',
                        ],
                        'vendor_registration_url' => 'https://femata.or.tz/contact?program=accelerator-2025&role=service-partner',
                        'participant_registration_url' => 'https://femata.or.tz/contact?program=accelerator-2025&role=participant',
                        'sponsor_registration_url' => 'https://femata.or.tz/contact?program=accelerator-2025&role=sponsor',
                        'floor_plan_url' => 'https://femata.or.tz/contact?program=accelerator-2025&asset=programme-layout',
                        'brochure_url' => 'https://femata.or.tz/contact?program=accelerator-2025&asset=brochure',
                        'is_current' => false,
                    ],
                ],
            ],
        ...
        $advertCampaigns = [
            ...
            [
                'slug' => 'newsroom-inline-sponsor-campaign',
                'title' => 'Newsroom Inline Sponsor Campaign',
                'media_type' => 'image',
                'asset_url' => 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=1600&q=80',
                'headline' => 'Premium newsroom placement for finance, media, and technology partners',
                'body' => 'This larger inline slot is designed to sit inside the newsroom flow, between lead stories and the wider archive, so it feels like a real premium campaign placement.',
                'cta_label' => 'Request newsroom placement',
                'cta_url' => 'https://www.femata.or.tz/contact',
                'page_key' => Advert::PAGE_NEWS,
                'slot_number' => 2,
                'placement_scope' => Advert::SCOPE_NATIONAL,
            ...
            [
                'slug' => 'newsroom-inline-video-campaign',
                'title' => 'Newsroom Inline Video Campaign',
                'media_type' => 'video',
                'asset_url' => 'https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4',
                'poster_url' => 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1600&q=80',
                'headline' => 'Video campaigns can rotate inside the FEMATA newsroom too',
                'body' => 'A second newsroom campaign in the same slot shows how timed video adverts can rotate with image placements for larger sponsor visibility.',
                'cta_label' => 'View newsroom media options',
                'cta_url' => 'https://www.femata.or.tz/contact',
                'page_key' => Advert::PAGE_NEWS,
                'slot_number' => 2,
                'placement_scope' => Advert::SCOPE_NATIONAL,
            ...
            [
                'slug' => 'gallery-inline-event-campaign',
                'title' => 'Gallery Inline Event Campaign',
                'media_type' => 'image',
                'asset_url' => 'https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&w=1600&q=80',
                'headline' => 'Event galleries can carry larger brand storytelling placements',
                'body' => 'This inline gallery campaign is designed to sit between grouped event albums so sponsors appear in a stronger and more premium visual context.',
            ...
            [
                'slug' => 'gallery-inline-video-campaign',
                'title' => 'Gallery Inline Video Campaign',
                'media_type' => 'video',
                'asset_url' => 'https://interactive-examples.mdn.mozilla.net/media/cc0-videos/flower.mp4',
                'poster_url' => 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1600&q=80',
                'headline' => 'Video placements can rotate between FEMATA event albums',
                'body' => 'A timed video advert in the gallery demonstrates how brand clips can rotate naturally between grouped event sections and photo stories.',
                'cta_label' => 'Book gallery video placement',
                'cta_url' => 'https://www.femata.or.tz/contact',
                'page_key' => Advert::PAGE_GALLERY,
                'slot_number' => 2,
                'placement_scope' => Advert::SCOPE_NATIONAL,
