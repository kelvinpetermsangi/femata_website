...
Route::put('/videos/{videoPost}', [VideoController::class, 'update'])->name('videos.update');
Route::delete('/videos/{videoPost}', [VideoController::class, 'destroy'])->name('videos.destroy');
...
Route::put('/press-briefings/{pressBriefing}', [PressBriefingController::class, 'update'])->name('press-briefings.update');
Route::delete('/press-briefings/{pressBriefing}', [PressBriefingController::class, 'destroy'])->name('press-briefings.destroy');
